...
from prescription.models import PatientPrescription, NoPatientPrescription
...
class ListPrescription(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        return {
                ...
                'list_prescription_no_patient': NoPatientPrescription.objects.filter(health_professional=self.request.user),
               }
